...
inputs = {
  ...
  # AWS-managed policies anexadas à execution role (dev-nix-ecs-exec).
  ...
  # AWS-managed policies anexadas à tasks role (dev-nix-ecs-task).
  ...
  # via SSM Session Manager) — `ssmmessages:*` abre o canal de control/data
